                ...
                <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-3">
                    <Card className="flex flex-col">
                        ...
                        <CardFooter className="mt-auto">
                            <Button variant="outline" className="w-full" render={<Link href="" />} nativeButton={false}>Get Started</Button>
                        </CardFooter>
                    </Card>
                    ...
                    <Card className="relative">
                        ...
                        <div className="flex flex-col">
                            ...
                            <CardFooter>
                                <Button className="w-full" render={<Link href="" />} nativeButton={false}>Get Started</Button>
                            </CardFooter>
                        </div>
                    </Card>
