...
export const CreditCardChip = ({
  ...
  children ? (
    <div
      className={cn(
        "-translate-y-1/2 absolute top-1/2 start-0 w-1/6 shrink-0 rounded-[18%]",
        className
      )}
    >
      {children}
...
export const CreditCardLogo = ({
  ...
  <div
    className={cn("absolute top-0 end-0 size-1/6", className)}
    {...props}
  />
);
...
export const CreditCardMagStripe = ({
  ...
  return (
    <div
      className={cn(
        "-translate-x-1/2 rtl:translate-x-1/2 absolute top-[3%] start-1/2 h-1/4 bg-gray-900",
        className
      )}
      style={{
