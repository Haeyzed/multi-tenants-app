...
import { useGetTaxRates } from "@/hooks/tenant/use-tax-rate-query"
import { useQueryErrorToast } from "@/hooks/use-query-error-toast"
import { TaxRatesBulkActions } from "./tax-rates-bulk-actions"
...
export function TaxRatesTable() {
  ...
  useQueryErrorToast(error, "Failed to load tax rates.")
  ...
  if (isLoading) {
    return (
      <DataTableSkeleton
        ...
        cellWidths={["auto", "8rem", "8rem", "6rem", "5rem", "6rem", "6rem"]}
      />
    )
  }
  ...
  return (
    <div className="data-table-container space-y-4">
      <DataTable
        table={table}
        actionBar={<TaxRatesBulkActions table={table} />}
      >
