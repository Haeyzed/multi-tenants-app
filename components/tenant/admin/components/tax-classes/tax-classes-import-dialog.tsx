...
import { useImportTaxClasses } from "@/hooks/tenant/use-tax-class-query"
import { downloadTaxClassesImportSample } from "@/lib/services/tenant/tax-class-service"
...
type TaxClassesImportDialogProps = {
  open: boolean
    ...
    >
      <ResponsiveDialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-md">
        <ResponsiveDialogHeader>
          ...
          <ResponsiveDialogDescription>
            Import tax classes from an Excel (.xlsx) or CSV file.
          </ResponsiveDialogDescription>
        </ResponsiveDialogHeader>
        <form
          id="tax-classes-import-form"
        ...
        <ResponsiveDialogFooter>
          ...
          <Button
            type="submit"
            form="tax-classes-import-form"
            disabled={importTaxClasses.isPending}
          >
            {importTaxClasses.isPending && <Spinner className="mr-2" />}
            Import
          </Button>
        </ResponsiveDialogFooter>
      </ResponsiveDialogContent>
