...
import { useGetSuppliers } from "@/hooks/tenant/use-supplier-query"
...
export function SuppliersTable() {
  ...
  useQueryErrorToast(error, "Failed to load suppliers.")
  ...
  if (isLoading) {
    return (
      <DataTableSkeleton
        ...
        cellWidths={["auto", "8rem", "10rem", "6rem", "6rem", "8rem", "3rem"]}
      />
    )
  }
  ...
  return (
    <div className="data-table-container space-y-4">
      <DataTable
        table={table}
        actionBar={<SuppliersBulkActions table={table} />}
      >
