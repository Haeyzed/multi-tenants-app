...
import { useImportCustomers } from "@/hooks/tenant/use-customer-query"
import { downloadCustomersImportSample } from "@/lib/services/tenant/customer-service"
  ...
  return (
    ...
    >
      <ResponsiveDialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-md">
        <ResponsiveDialogHeader>
          <ResponsiveDialogTitle>Import Customers</ResponsiveDialogTitle>
          <ResponsiveDialogDescription>
            Import customers from an Excel (.xlsx) or CSV file.
          </ResponsiveDialogDescription>
        </ResponsiveDialogHeader>
        <form
        ...
        <ResponsiveDialogFooter>
          ...
          >
            {importCustomers.isPending && <Spinner className="mr-2" />}
            Import
          </Button>
        </ResponsiveDialogFooter>
      </ResponsiveDialogContent>
