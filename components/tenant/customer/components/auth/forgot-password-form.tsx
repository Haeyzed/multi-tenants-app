...
export function ForgotPasswordForm({
  ...
  const forgotPasswordMutation = useCustomerForgotPassword()

  const form = useForm<z.infer<typeof customerForgotPasswordSchema>>({
    resolver: zodResolver(customerForgotPasswordSchema),
    defaultValues: { email: "" },
  })

  const onSubmit = (values: z.infer<typeof customerForgotPasswordSchema>) => {
